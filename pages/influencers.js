    ...
    return (
        <>
            ...
            <div className="py-20 relative">
                <h1 className="mt-20 text-4xl md:text-5xl font-bold text-center text-gray-800">The Neuron Coach</h1>
                <h1 className="text-lg mx-auto md:text-xl max-w-6xl px-8 mt-4 mb-8 text-center text-gray-600"> Join TheNeuron.Club platform to run prediction contests amongst your followers and win rewards. Please <a href="/contact" className="text-blue-400 cursor-pointer">contact us </a>to signup on the platform as an influencer</h1>

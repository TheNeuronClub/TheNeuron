    ...
    return (
        <>
            ...
            <div className="py-20 relative">
                ...
                <h1 className="text-lg mx-auto md:text-xl max-w-6xl px-8 my-2 mb-8 text-center text-gray-600"> Join TheNueron.Club platform to run prediction contests amongst your followers and win rewards. Please <a href="/contact" className="text-blue-400">contact us </a> to signup on the platform as an influencer</h1>

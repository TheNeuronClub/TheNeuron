        ...
        <>
            <div className={`p-5 py-10 sm:p-10 xl:px-20 min-w-full mx-auto text-white`}>
                <div className="flex justify-between border-b-2 mb-4 pb-2 border-gray-200">
                    ...
                    <Link href='/question/'>
                        <h1 className="hidden md:flex items-center text-base sm:text-lg cursor-pointer hover:text-yellow-400 sm:pr-4">View All <ArrowRightIcon className="h-7 mx-2" /></h1>
                    </Link>
                </div>

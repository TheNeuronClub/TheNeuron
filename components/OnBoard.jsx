...
const data = [
    ...
    { id: 3, imgSrc: '/images/onboard/3.png', text: `You receive a joining bonus of 1000 coins. 1 US Dollar is equivalent to 100 coins. Continue to earn more coins with several activities. Check FAQs for details.` },

            ...
            <motion.div initial="initial"
                ...
                {!contest &&
                    <>
                        ...
                        <div className="flex items-center my-5 p-2 gap-x-4 md:gap-x-8 max-w-7xl mx-auto overflow-x-auto scroll-hidden rounded-full md:text-lg">
                            <div className={`capitalize relative min-w-max max-w-max py-2 px-4 rounded-full bg-white text-gray-900 font-medium transform hover:scale-105 cursor-pointer transition-sm shadow-md ${filter.category == '' ? 'scale-105 border-2 border-yellow-500 bg-yellow-200 gradient-shadow' : 'border-2 border-gray-200'}`} onClick={() => setFilter({ ...filter, category: '' })}>All</div>
